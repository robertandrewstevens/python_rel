---
title: "A Complete Guide To Survival Analysis In Python, part 2"
...
knitr::opts_chunk$set(
  ...
  echo = TRUE,
  engine.path = list(
    python = '/anaconda3/envs/py3.8/bin/python'
  )
)
...
# in Terminal below
# 1 time
# $ conda create -n py3.8 python=3.8 scikit-learn pandas numpy matplotlib lifelines
